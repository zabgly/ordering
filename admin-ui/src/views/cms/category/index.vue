    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['cms:category:export']"
        >导出</el-button>
      </el-col>
...
<!--      <el-table-column label="分类ID" align="center" prop="id" />-->
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="父分类" prop="userId">
    ...
    <!-- 查看菜品弹框 -->
    <el-dialog title="菜品列表" :visible.sync="productDialogVisible" width="800px" append-to-body>
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除菜品分类编号为"' + ids + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('cms/category/export', {
        ...this.queryParams
    ...
    handleViewProduct(row) {
      ...
      this.productList = row.cmsProductList || [];
    }
  }
};
</script>
