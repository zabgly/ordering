...
<!--      <el-table-column v-if="true" label="评价ID" align="center" prop="id" />-->
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="评分: 1-5" prop="rating">
          <el-input v-model="form.rating" placeholder="请输入评分: 1-5" />
        </el-form-item>
      </el-form>
...
<script>
import { listReview, getReview, delReview, addReview, updateReview } from "@/api/ums/review";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除菜品评价编号为"' + ids + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('ums/review/export', {
        ...this.queryParams
