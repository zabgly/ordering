    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['ums:favorite:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['ums:favorite:export']"
        >导出</el-button>
      </el-col>
...
<!--      <el-table-column label="收藏ID" align="center" prop="id" />-->
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="菜品" prop="userId">
...
<script>
import { listFavorite, getFavorite, delFavorite, addFavorite, updateFavorite } from "@/api/ums/favorite";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('ums/favorite/export', {
        ...this.queryParams
